...
# b Cargar al menos tres aristas para cada vértice
...
print("Total de metros de cables necesarios para conectar todos los ambientes:",
      distancia_total_mst, "metros")
...
print("Distancia total desde habitación 1 hasta sala de estar:",
