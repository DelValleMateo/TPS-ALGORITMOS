...
class Graph:
    ...
    def show_graph(self):
        ...
        for index, nodo in enumerate(self.elements):
            ...
            for second_index, second_element in enumerate(nodo['aristas']):
                print(
                    f"    destino{second_element['value']} peso: {second_element['peso']}")
        print()
            ...
            for adjacente in adjacentes:
                ...
                if pos is not None:
                    if costo_nodo_actual + adjacente['peso'] < no_visitados.elements[pos][0]:
                        ...
                        no_visitados.change_proirity(
                            pos, costo_nodo_actual + adjacente['peso'])
        return camino
    ...
    def kruskal(self, origen):
        ...
        for nodo in self.elements:
            ...
            for adjacente in adjacentes:
                aristas.arrive(
                    [nodo['value'], adjacente['value']], adjacente['peso'])
    ...
    #     # Agregar todos los vértices al bosque
    #     for nodo in self.elements:
    #         bosque.append(nodo['value'])
    #         adjacentes = nodo['aristas']
    #         for adyacente in adjacentes:
    #             aristas.arrive(
    #                 [nodo['value'], adyacente['value']], adyacente['peso'])
    ...
    #                 # Agregar la arista al árbol resultante
    #                 arbol_resultante.append(
    #                     f'{vertice_ori}-{vertice_des}-{arista[0]}')
    #                 # Combina los árboles
    #                 bosque.append(vertice_ori + '-' + vertice_des)
